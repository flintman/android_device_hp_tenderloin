...
# Device manifest
DEVICE_MANIFEST_FILE := device/hp/tenderloin/manifest.xml
DEVICE_MATRIX_FILE := device/hp/tenderloin/compatibility_matrix.xml
...
TARGET_RECOVERY_FSTAB := device/hp/tenderloin/rootdir/etc/fstab.tenderloin
